    ...
    <div class="col-md-3 well" style="height: 900px; margin: 10px; margin-left: 40px;">
        ...
        <ul class="list-unstyled" style="margin-left: 30px;">
            ...
            foreach ($path_scan as $e) {
                $e_file = (($current_path == '/') ? '' : $current_path) . '/' . $e;
                $e_dir = (($current_path == '/') ? '' : $current_path) . '/' . $e;
                if(is_file($current_real_path . '/' . $e)) {
                    echo "<li style=\"font-family: monospace; padding:2px 4px; font-size:90%; color:#c7254e;\"><a href=\"index.php?path=" . $e_file  . "\">" . $e . "</a></li>";
                } else {
                    echo "<li><code><a href=\"index.php?path=" . $e_dir  . "\">" . $e . "</a></code></li>";
                }
            }
            ?>
        </ul>
